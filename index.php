...
<body>
    <!-- banner-inner -->
    <div id="demo-1" data-zs-src='["images/homeimg1.jpg", "images/homeimg2.jpg"]' data-zs-overlay="dots">
...
while ($row = mysqli_fetch_array($ret)) {
    ...
    ?> <div class="job-post-main row">
                                                ...
                                                <div class="job-single-sec">
                                                    ...
                                                    <ul class="job-list-info d-flex">
                                                        <li>
                                                            ...
                                                            <?php echo $row['NoofOpenings']; ?>
                                                        </li>
                                                        <li>
                                                            <i class="fas fa-dollar-sign"></i>
                                                            <?php echo $row['MonthlySalary']; ?>/Month
                                                        </li>
                                                        <li>
                                                            <i
                                                                class="fas fa-map-marker-alt"></i><?php echo $row['JobLocation']; ?>
                                                        </li>
                                                        <li><i class="fas fa-calendar"></i>
                                                            <?php echo $row['LastDate']; ?></li>
                                                    </ul>
                                            ...
                                            <div class="col-md-3 job-single-time text-right">
                                                <span class="job-time">
                                                    <a href="single-job-details.php?viewid=<?php echo $row['ID']; ?>"
                                                        class="aply-btn "> Details</span></a>
    ...
    ?>
                                        <div class="job-post-main row">
                                            ...
                                            <div class="col-md-3 job-single-time text-right">
                                                <span class="job-time">
                                                    <a href="single-job-details.php?viewid=<?php echo $row['ID']; ?>"
                                                        class="aply-btn "> Details</span>
                                                <?php if ($_SESSION['crmsuid'] == "") {?>
                                                <a href="user/login.php" class="aply-btn ">Apply Now</a>
                                                <?php }?>
                                            </div>
            ...
            <div class="inner-sec-w3ls py-lg-5  py-3">
                <div class="mid-info text-center pt-3">
                    <h3 class="tittle text-center cen mb-lg-5 mb-3">
                        <span>Reminder</span>Taking action is the first key to sucess, So take your first
                        action by
