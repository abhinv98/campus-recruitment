...
<head>
    ...
    <title>CRMS-Vacancy Detail</title>
    <!-- CSS -->
                                    ...
                                    <table class="table table-bordered table-hover data-tables">
                                        <form method="post" name="submit" enctype="multipart/form-data">
                                            ...
                                            <tr>
                                                <th>Upload Resume :</th>
                                                <td>
                                                    <input type='file' name="resume" placeholder="resume" rows="12"
                                                        cols="14" class="form-control wd-450" required="true">
                                                </td>
                                            </tr>
        ...
        ?>
                                            <tr align="center">
                                                <td colspan="2"><button type="submit" name="submit"
                                                        class="btn btn-primary">Apply Now</button></td>
                                            </tr>
                                            <?php } else {?>
                                            <tr>
                                                <th colspan="2"
                                                    style="text-align:center; font-weight:bold; color:red; font-size:22px;">
                                                    Job Expired</tthd>
                                            </tr>
                                            <?php }?>
                                        </form>
