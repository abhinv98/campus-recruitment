        ...
        ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="images/<?php echo $row['Image']; ?>" width="200" height="150"
                                                ...
                                                href="changeimage.php?editid=<?php echo $row['ID']; ?>"> &nbsp; Upload
                                                Image</a>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="dob" name="dob" class="form-control"
                                                value="<?php echo $row['DOB']; ?>" required='true'>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress2" class="col-form-label">Registration Date</label>
                                            <input type="text" id="" name="" class="form-control"
                                                value="<?php echo $row['UserRegdate']; ?>" readonly='true'>
                                        </div>
                                        <?php }?>
