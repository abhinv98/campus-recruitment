...
<head>
    ...
    <title>CRMS-Add Education Detail</title>
    <!-- CSS -->
...
$uid = $_SESSION['crmsuid'];
    ...
    if ($rw > 0) {
        while ($row = mysqli_fetch_array($query)) {
            ?>
                                    <p style="font-size:16px; color:red" align="center">Your Education Detail has
                                        already added.</p>
                                        ...
                                        <table class="table table-bordered table-hover data-tables">
                                            ...
                                            <tr>
                                                ...
                                                <td> <input class="form-control white_bg" id="10thboard"
                                                        name="10thboard" placeholder="Board / University" type="text"
                                                        required='true'></td>
                                                <td> <input class="form-control white_bg" id="10thpyeaer"
                                                        name="10thpyear" placeholder="Year" type="text" required='true'>
                                                </td>
                                                ...
                                                <td> <input class="form-control white_bg" id="10thcgpa" name="10thcgpa"
                                                        placeholder="CGPA" type="text" required='true'></td>
                                            </tr>
                                            <tr>
                                                <th>12th(Senior Secondary)</th>
                                                <td> <input class="form-control white_bg" id="12thboard"
                                                        ...
                                                        required='true'></td>
                                                <td> <input class="form-control white_bg" id="12thboard"
                                                        name="12thpyear" placeholder="Year" type="text" required='true'>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td> <input class="form-control white_bg" id="graduation"
                                                        name="graduation" placeholder="Board / University" type="text">
                                                </td>
                                                ...
                                                <td> <input class="form-control white_bg" id="graduationcgpa"
                                                        name="graduationcgpa" placeholder="CGPA" type="text"></td>

                                            </tr>
                                            <tr>
                                                <th>Post Graduation</th>
                                                <td> <input class="form-control white_bg" id="postgraduation"
                                                        name="postgraduation" placeholder="Board / University"
                                                        type="text"></td>
                                                ...
                                                <td> <input class="form-control white_bg" id="pgpercentage"
                                                        name="pgpercentage" placeholder="Percentage" type="text"></td>
                                                <td> <input class="form-control white_bg" id="pgcgpa" name="pgcgpa"
                                                        placeholder="CGPA" type="text"></td>
                                            </tr>
