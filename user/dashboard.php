...
<head>
    <title>CRMS-User Dashboard</title>
    <!-- CSS -->
                ...
                <div class="animated fadeInUpShort">
                    <div class="card">
                        <div class="card-header black">
                            <h6 body style="color:white">Dashboard </h6>
                        </div>
                        <div class="card-body p-0">
                            <div class="lightSlider" data-item="5" data-item-xl="4" data-item-md="2" data-item-sm="1"
...
//todays applied Jobs
    ...
    ?>
                                    ...
                                    <span
                                        class="s-48 font-weight-lighter text-primary"><?php echo $count_today_appjob; ?></span>
...
//Yesterday applied Jobs
    ...
    ?>
                                    ...
                                    <span
                                        class="s-48 font-weight-lighter light-green-text"><?php echo $count_yday_appjob; ?></span>
...
//Last Sevendays applied Jobs
    ...
    ?>
                                    ...
                                    <span
                                        class="s-48 font-weight-lighter text-primary"><?php echo $count_sevenday_appjob; ?></span>
...
//Total applied Jobs
    ...
    ?>
                                    ...
                                    <span
                                        class="s-48 font-weight-lighter amber-text"><?php echo $count_total_appjob; ?></span>
...
//Total Vacancy
    ...
    ?>
                                    ...
                                    <span
                                        class="s-48 font-weight-lighter text-indigo"><?php echo $count_total_vacancy; ?></span>
