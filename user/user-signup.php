                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 p-t-100">
                            <img src="assets/img/icon/lubo-minar-B-gb_8fgmz8-unsplash-modified.png" alt="">
                        </div>
                        <div class="col-lg-6 p-t-100">
                            <div class="text-white">
                                <h1>There You are</h1>
                                <p class="s-18 p-t-b-20 font-weight-lighter">Go on register yourself so we can look into
                                    your dashboard</p>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-o"></i>
                                            <input type="text" class="form-control form-control-lg no-b" name="fullname"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-o"></i>
                                            <input type="email" class="form-control form-control-lg no-b" name="email"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                            <input type="text" name="stuid" required="true"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="radio" name="gender" id="gender" value="Female"
                                            checked="true"><strong style="color: white">Female</strong>
                                        <label>
                                            <input type="radio" name="gender" id="gender" value="Male"><strong
                                                style="color: white">Male</strong>
                                        </label>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <p class="forget-pass text-white"><a href="forgot-password.php"> Back to
                                                Home!!</a></p>
                                    </div>
                                </div>
                            </form>
