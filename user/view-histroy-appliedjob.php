...
<head>
    ...
    <title>CRMS-History of applied Jobs</title>
    <!-- CSS -->
    ...
    while ($row = mysqli_fetch_array($ret)) {
        ...
        ?>
                                    <table class="table table-bordered table-hover data-tables">
                                        ...
                                        <tr>
                                            <th>Image </th>
                                            <td><img src="images/<?php echo $row['Image']; ?>" width="200" height="150"
                                                    value="<?php echo $row['Image']; ?>"></td>

                                            <th>Education Detail </th>
                                            <td><a href="view-education-detail.php?eduid=<?php echo $row['uid']; ?>"
                                                    target="_blank">My Education Details</a></td>
                                        </tr>
                                        <tr>
                                            <th>Resume </th>
                                            <td> <a href="images/<?php echo $row['Resume']; ?>" width="200" height="150"
                                                    value="<?php echo $row['Resume']; ?>" target="_blank">Download</a>
                                            </td>
