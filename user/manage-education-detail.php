...
<body class="light">
    ...
    <div id="app">
        ...
        <div class="page has-sidebar-left">
            <header class="black accent-3 relative">
            ...
            ?>
                                        <table class="table table-bordered table-hover data-tables">
                                            ...
                                            <tr>
                                                ...
                                                <td> <input class="form-control white_bg" id="10thboard"
                                                        name="10thboard" value="<?php echo $row['SecondaryBoard']; ?>"
                                                        type="text" required='true'></td>
                                                <td> <input class="form-control white_bg" id="10thpyeaer"
                                                        name="10thpyear"
                                                        value="<?php echo $row['SecondaryBoardyop']; ?>" type="text"
                                                        required='true'></td>
                                                <td> <input class="form-control white_bg" id="10thpercentage"
                                                        name="10thpercentage"
                                                        value="<?php echo $row['SecondaryBoardper']; ?>" type="text"
                                                        required='true'></td>
                                                <td> <input class="form-control white_bg" id="10thcgpa" name="10thcgpa"
                                                        value="<?php echo $row['SecondaryBoardcgpa']; ?>" type="text"
                                                        required='true'></td>
                                            </tr>
                                            <tr>
                                                <th>12th(Senior Secondary)</th>
                                                <td> <input class="form-control white_bg" id="12thboard"
                                                        name="12thboard" value="<?php echo $row['SSecondaryBoard']; ?>"
                                                        type="text" required='true'></td>
                                                <td> <input class="form-control white_bg" id="12thboard"
                                                        name="12thpyear"
                                                        value="<?php echo $row['SSecondaryBoardyop']; ?>" type="text"
                                                        required='true'></td>
                                                <td> <input class="form-control white_bg" id="12thpercentage"
                                                        name="12thpercentage"
                                                        value="<?php echo $row['SSecondaryBoardper']; ?>" type="text"
                                                        required='true'></td>
                                                <td> <input class="form-control white_bg" id="12thcgpa" name="12thcgpa"
                                                        value="<?php echo $row['SSecondaryBoardcgpa']; ?>" type="text"
                                                        required='true'></td>
                                            </tr>
                                            <tr>
                                                <th>Graduation</th>
                                                <td> <input class="form-control white_bg" id="graduation"
                                                        name="graduation" value="<?php echo $row['GraUni']; ?>"
                                                        type="text" required='true'></td>
                                                <td> <input class="form-control white_bg" id="graduationpyeaer"
                                                        name="graduationpyeaer" value="<?php echo $row['GraUniyop']; ?>"
                                                        type="text" required='true'></td>
                                                <td> <input class="form-control white_bg" id="graduationpercentage"
                                                        name="graduationpercentage"
                                                        value="<?php echo $row['GraUnidper']; ?>" type="text"
                                                        required='true'></td>
                                                <td> <input class="form-control white_bg" id="graduationcgpa"
                                                        name="graduationcgpa" value="<?php echo $row['GraUnicgpa']; ?>"
                                                        type="text" required='true'></td>

                                            </tr>
                                            <tr>
                                                <th>Post Graduation</th>
                                                <td> <input class="form-control white_bg" id="postgraduation"
                                                        name="postgraduation" value="<?php echo $row['PGUni']; ?>"
                                                        type="text"></td>
                                                <td> <input class="form-control white_bg" id="pgpyeaer" name="pgpyear"
                                                        value="<?php echo $row['PGUniyop']; ?>" type="text"></td>
                                                <td> <input class="form-control white_bg" id="pgpercentage"
                                                        name="pgpercentage" value="<?php echo $row['PGUniper']; ?>"
                                                        type="text"></td>
                                                <td> <input class="form-control white_bg" id="pgcgpa" name="pgcgpa"
                                                        value="<?php echo $row['PGUnicgpa']; ?>" type="text"></td>
                                            </tr>
                                        ...
                                        <table class="table table-bordered table-hover data-tables">
                                            <tr>
                                                ...
                                                <td> <input class="form-control white_bg" id="extracurr"
                                                        name="extracurr" value="<?php echo $row['ExtraCurriculars']; ?>"
                                                        type="text"></td>
                                            </tr>
                                            <tr>
                                                <th>Other Achivement/Certificate/Qualification</th>
                                                <td> <input class="form-control white_bg" id="otherach" name="otherach"
                                                        value="<?php echo $row['OtherAchivement']; ?>" type="text"></td>
                                            </tr>
                                        </table>
