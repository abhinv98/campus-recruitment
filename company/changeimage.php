...
<head>
    <title>CRMS-Change Company Logo</title>
    <!-- CSS -->
    ...
    while ($row = mysqli_fetch_array($ret)) {
        ...
        ?>
                                        <div class="form-group">
                                            ...
                                            <img src="images/<?php echo $row['CompanyLogo']; ?>" width="100"
                                                height="100" value="<?php echo $row['CompanyLogo']; ?>">
                                        </div>
                                        <div class="form-group">
        ...
        <div class="control-sidebar-bg shadow blue fixed"></div>
    </div>
    <!--/#app -->
