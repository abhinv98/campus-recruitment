    ...
    while ($row = mysqli_fetch_array($ret)) {
        ...
        ?>
                                    <table class="table table-bordered table-hover data-tables">
                                        ...
                                        <tr>
                                            <th>Image </th>
                                            <td><img src="../user/images/<?php echo $row['Image']; ?>" width="200"
                                                    height="150" value="<?php echo $row['Image']; ?>"></td>
                                            <th>Education Detail </th>
                                            <td><a href="view-education-detail.php?eduid=<?php echo $row['uid']; ?>"
                                                    target="_blanks">Candidate Education Details</a></td>
                                        </tr>
                                        <tr>
                                            <th>Resume </th>
                                            <td> <a href="../user/images/<?php echo $row['Resume']; ?>" width="200"
                                                    height="150" value="<?php echo $row['Resume']; ?>"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select name="status" class="form-control wd-450"
                                                                        required="true">
                                                                        <option value="Rejected" selected="true">
                                                                            Rejected</option>
