...
<head>
    <title>CRMS-Company Dashboard</title>
    <!-- CSS -->
                ...
                <div class="animated fadeInUpShort">
                    <div class="card">
                        <div class="card-header black">
                            <h6 body style="color:white"> Company Dashboard </h6>
                        </div>
...
$cid = $_SESSION['crmscid'];
    ...
    ?>
                                    ...
                                    <span
                                        class="s-48 font-weight-lighter light-green-text"><?php echo $totalapplications; ?></span>
    ...
    ?>
                                    ...
                                    <span
                                        class="s-48 font-weight-lighter text-primary"><?php echo $totalnewapp; ?></span>
    ...
    ?>
                                    ...
                                    <span
                                        class="s-48 font-weight-lighter text-indigo"><?php echo $totalrejapp; ?></span>
