        ...
        <main>
            <div id="primary" class="black p-t-b-100 height-full responsive-phone">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="assets/img/icon/white.jpg" alt="">
                        </div>
                        <div class="col-lg-6 p-t-100">
                            <div class="text-white">
                                <h1>Welcome Back</h1>
                                <p class="s-18 p-t-b-20 font-weight-lighter">Login to proceed to your workplace</p>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <p class="forget-pass text-white"><a href="forgot-password.php"> Have you forgot
                                                your password ?</a> <a href="comp-signup.php"
                                                style="padding-left: 250px"> Sign Up!!</a></p>
