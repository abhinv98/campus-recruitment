        ...
        ?>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="comname" name="comname"
                                                    value="<?php echo $row['CompanyName']; ?>" required='true'>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="inputPassword4" class="col-form-label">Contact
                                                    Person</label>
                                                <input type="text" id="conperson" name="conperson" class="form-control"
                                                    value="<?php echo $row['ContactPerson']; ?>" required='true'>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="comurl" name="comurl" class="form-control"
                                                value="<?php echo $row['CompanyUrl']; ?>" required='true'>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Company Address</label>
                                            <input type="text" id="compadd" name="compadd" class="form-control"
                                                value="<?php echo $row['CompanyAddress']; ?>" required='true'>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Mobile Number</label>
                                            <input type="text" id="$mobno" name="$mobno" class="form-control"
                                                value="<?php echo $row['MobileNumber']; ?>" readonly='true'>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress2" class="col-form-label">Email address</label>
                                            <input type="email" id="compemail" name="compemail" class="form-control"
                                                value="<?php echo $row['CompanyEmail']; ?>" readonly='true'>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress2" class="col-form-label">Company Logo</label>
                                            <img src="images/<?php echo $row['CompanyLogo']; ?>" width="200"
                                                height="150" value="<?php echo $row['CompanyLogo']; ?>"><a
                                                href="changeimage.php?editid=<?php echo $row['ID']; ?>"> &nbsp; Edit
                                                Image</a>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress2" class="col-form-label">Company Registration
                                                Date</label>
                                            <input type="text" id="" name="" class="form-control"
                                                value="<?php echo $row['CompanyRegdate']; ?>" readonly='true'>
                                        </div>
                                        <?php }?>
