        ...
        <main>
            <div id="primary" class=" black p-t-b-100 height-full responsive-phone">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="assets/img/icon/2-14-10-21-11-59-52m.jpg" height=600 width=600 alt="">
                        </div>
                        <div class="col-lg-6 p-t-100">
                            <div class="text-black">
                                <h1 body style="color: white ">Welcome to CRMS</h1>
                                <p class="s-18 p-t-b-20 font-weight-lighter" body style="font: bold; color: white;">
                                    Complete
                                    your registration to proceed
                                    forward</p>
                            </div>
                            <form method="post" action="" name="signup" method="post" onsubmit="return checkpass();"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-o"></i>
                                            <input type="text" class="form-control form-control-lg no-b" name="comname"
                                                id="comname" placeholder="Name of Company" required="true">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-o"></i>
                                            <input type="text" class="form-control form-control-lg no-b"
                                                name="conperson" id="conperson" placeholder="Name of Contact Person"
                                                required="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-o"></i>
                                            <input type="email" class="form-control form-control-lg no-b"
                                                name="compemail" id="compemail" placeholder="Email of Company"
                                                required="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                            <input type="password" name="repeatpassword" required="true"
                                                class="form-control form-control-lg no-b" placeholder="Repeat Password">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                            <input type="text" name="mobilenumber" required="true"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                            <input type="text" name="comurl" required="true"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                            <input type="text" name="compadd" required="true"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                            <input type="file" name="complogo" required="true"
                                                class="form-control form-control-lg no-b" title="Company logo">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <input type="submit" class="btn btn-success btn-lg btn-block" name="submit"
                                            value="Sign Up">
                                        <p class="forget-pass text-white"><a href="login.php">
                                                Already Have an
                                                Account</a></p>
