        ...
        ?>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="jobtitle" name="jobtitle"
                                                    required="true" value="<?php echo $row['JobTitle']; ?>">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4" class="col-form-label">Monthly In-hand
                                                    Salary </label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="noofopenings"
                                                    required="true" value="<?php echo $row['NoofOpenings']; ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="date-time-picker form-control"
                                                    data-options='{"timepicker":false, "format":"d-m-Y"}' id="applydate"
                                                    name="applydate" required="true"
                                                    value="<?php echo $row['ApplyDate']; ?>">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="date-time-picker form-control"
                                                    data-options='{"timepicker":false, "format":"d-m-Y"}' id="lastdate"
                                                    name="lastdate" required="true"
                                                    value="<?php echo $row['LastDate']; ?>">
                                                <span class="input-group-append">
                                                    <span class="input-group-text add-on white">
                                                        <i class="icon-calendar"></i>
                                                    </span>
