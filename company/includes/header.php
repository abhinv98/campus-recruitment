...
error_reporting(0);
?>
<div class="navbar navbar-expand d-flex navbar-dark justify-content-between bd-navbar black accent-3 shadow">
    <div class="relative">
        <div class="d-flex">
            <div>
            ...
            <div class="black d-none d-md-block">
    ...
    while ($result = mysqli_fetch_array($ret1)) {
        ?>
                                ...
                                <a class="dropdown-item"
                                    href="new-applications.php?viewid=<?php echo $result['ID']; ?>"><i
                                        class="icon icon-data_usage text-success"></i>New Application Received from
                                    <?php echo $result['FullName']; ?></a>
                                < </li>
                                    <?php }} else {?>
