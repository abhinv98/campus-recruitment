...
?>
<aside class="main-sidebar fixed offcanvas black shadow">
    <section class="sidebar">
        <div class="w-80px mt-3 mb-3 ml-3">
            <h2 align="center " body style="color:white"> CRMS.</h2>
        </div>
        <div class="relative">
...
?>
                    ...
                    <div class="float-left image" body style="color:green">
                        <img class="user_avatar" src="images/<?php echo $logo; ?>" alt="<?php echo $name; ?>"
                            height="60">
                    </div>
                    <div class="float-left info">

                        <h6 class="font-weight-light mt-2 mb-1" body style="color:white"><?php echo $name; ?></h6>
                ...
                <div class="collapse multi-collapse" id="userSettingsCollapse">
                    <div class="list-group mt-3 shadow">
                        <a href="company-profile.php" class="list-group-item list-group-item-action ">
                            <i class="mr-2 icon-umbrella text-red"></i>Profile
                        </a>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="icon icon-documents3 text-blue s-18"></i>Job Applications<i
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="sort-listed-applications.php"><i class="icon icon-check"></i> Sort Listed
                            Applications</a>
                    </li>
            ...
            <li class="treeview ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="application-counts-reports.php"><i class="icon icon-date_range"></i>Applications Count
                            Reports</a>
                    </li>
