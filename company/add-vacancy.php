                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="jobtitle" name="jobtitle"
                                                    required="true" placeholder="Job Title">
                                            </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="noofopenings"
                                                    required="true" placeholder="No of Opening">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="date-time-picker form-control"
                                                    ...
                                                    value="2018/06/01" / id="applydate" name="applydate"
                                                    required="true">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="date-time-picker form-control"
                                                    data-options='{"timepicker":false, "format":"d-m-Y"}'
                                                    value="2018/06/01" / id="lastdate" name="lastdate" required="true">
                                                <span class="input-group-append">
                                                    <span class="input-group-text add-on white">
                                                        <i class="icon-calendar"></i>
                                                    </span>
